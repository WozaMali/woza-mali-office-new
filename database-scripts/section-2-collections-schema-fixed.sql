-- ============================================================================
-- SECTION 2: COLLECTIONS MANAGEMENT SCHEMA (FIXED)
-- ============================================================================
...
-- ============================================================================
-- 6. GREEN SCHOLAR FUND CALCULATION
-- ============================================================================
...
-- View for Green Scholar Fund tracking
...
SELECT 
    ...
    SUM(weight_kg) as total_pet_weight_kg,
    SUM(green_scholar_fund_amount) as total_contribution,
    AVG(weight_kg) as avg_collection_weight
FROM public.collections c
JOIN public.materials m ON c.material_id = m.id
WHERE c.contributes_to_green_scholar_fund = true
...
BEGIN
    ...
    RAISE NOTICE '💰 Pricing: Aluminium Cans R18.55/kg, PET Bottles R1.50/kg (Green Scholar Fund)';
    RAISE NOTICE '🔒 RLS policies enabled for security';
    RAISE NOTICE '📈 Indexes created for performance';
    RAISE NOTICE '🌱 Seed data inserted for materials';
    RAISE NOTICE '👁️ Views created: collection_details, collector_stats, green_scholar_fund_summary';
    RAISE NOTICE '🎓 Green Scholar Fund tracking enabled for PET bottles';
END $$;
