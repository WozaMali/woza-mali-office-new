...
-- This approach works with the actual users table structure and avoids township_id issues
...
BEGIN
    ...
    -- Insert user record with only existing columns (township_id set to NULL to avoid UUID issues)
...
BEGIN
    ...
    RAISE NOTICE 'The application should now work without UUID conversion issues.';
END $$;
