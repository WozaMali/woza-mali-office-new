-- ============================================================================
-- POPULATE MATERIALS DATABASE - CLEAN VERSION
-- ============================================================================
...
BEGIN
  ...
  INSERT INTO public.materials (name, unit, rate_per_kg, is_active, description, category_id) VALUES
    ...
    -- Plastics
    ('PET Bottles', 'kg', 1.50, true, 'Clear PET plastic bottles', plastics_id),
    ('HDPE Bottles', 'kg', 2.20, true, 'HDPE plastic bottles', plastics_id),
...
-- 8. Show sample materials with categories
-- ============================================================================
...
JOIN public.material_categories c ON m.category_id = c.id
