-- ============================================================================
-- RESET GREEN SCHOLAR FUND (CLEAN VERSION)
-- ============================================================================
...
SELECT 'Reset green_scholar_fund_balance to 0' as result;
...
SELECT 
    ...
    'GREEN SCHOLAR TRANSACTIONS REMAINING' as description
FROM green_scholar_transactions;

-- Check if any contributions remain
SELECT 
    COUNT(*) as remaining_contributions,
    'GREEN SCHOLAR CONTRIBUTIONS REMAINING' as description
FROM collection_green_scholar_contributions;
...
SELECT 'GREEN SCHOLAR FUND RESET COMPLETED' as result;
