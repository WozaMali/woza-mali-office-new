...
-- Check what materials are associated with these collections
...
SELECT 
    ...
    cm.quantity,
    cm.price_per_kg,
    (cm.quantity * cm.price_per_kg) as calculated_value
...
-- Note: This assumes collection_materials has quantity and price_per_kg columns
...
FROM (
    SELECT 
        collection_id,
        SUM(quantity * price_per_kg) as total_value
