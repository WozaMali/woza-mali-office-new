...
-- ============================================================================
-- This script contains everything needed to set up the Green Scholar Fund system
...
-- Sample schools data (only insert if they don't exist)
...
-- Sample child-headed homes data (only insert if they don't exist)
