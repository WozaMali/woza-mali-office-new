-- ============================================================================
-- COMPLETE SUPER ADMIN SETUP - HANDLES ALL TYPE ISSUES
-- ============================================================================
-- This script handles all column type issues and creates everything properly
...
-- Step 6: Fix role_id column type to UUID if it's not already
DO $$ 
BEGIN
    -- Check if role_id column exists and is not UUID type
    IF EXISTS (
        ...
        RAISE NOTICE 'Updated role_id column type to UUID';
    ELSE
...
-- Show column types
SELECT 'Column types verification:' as info;
SELECT 
    column_name, 
    data_type, 
    is_nullable
