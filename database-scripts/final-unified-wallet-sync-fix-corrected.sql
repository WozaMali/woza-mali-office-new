-- ============================================================================
-- FINAL UNIFIED WALLET SYNC FIX - CORRECTED TABLE NAMES
-- ============================================================================
-- This script fixes all remaining RLS and permission issues using correct table names

-- 1. Create test users if they don't exist (using correct 'users' table)
-- ============================================================================
...
INSERT INTO public.users (
    ...
    ('00000000-0000-0000-0000-000000000000', 'test.user@wozamali.com', 'Test', 'User', '+27123456789', '1', 'active', 'hashed_password'),
    ('00000000-0000-0000-0000-000000000001', 'test.collector@wozamali.com', 'Test', 'Collector', '+27123456790', '2', 'active', 'hashed_password'),
    ('00000000-0000-0000-0000-000000000002', 'test.admin@wozamali.com', 'Test', 'Admin', '+27123456791', '3', 'active', 'hashed_password')
...
INSERT INTO public.roles (
    ...
    ('1', 'resident', 'Regular user/resident'),
    ('2', 'collector', 'Collection staff'),
...
CREATE POLICY "Users can view collections" ON public.collections
    FOR SELECT USING (
        ...
        EXISTS (
            ...
            WHERE u.id = auth.uid() AND r.name IN ('admin', 'collector')
        )
    );
